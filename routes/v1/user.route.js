...
import { uploadImageController } from "../../controllers/mediaControl.controller/mediaUpload.js";
...
router.post('/uploadProfilePicture', upload.fields([{ name: 'image', maxCount: 1 }]), uploadImageController);
